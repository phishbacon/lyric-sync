...
export const insertServerSchema = createInsertSchema(
  servers,
  {
    serverName: schema => schema.min(1, "Server name is required"),
...
export const insertLibrarySchema = createInsertSchema(
  libraries,
  {
    ...
    uuid: schema => schema.min(1, "UUID is required"),
...
export const insertArtistSchema = createInsertSchema(
  artists,
  {
    ...
    uuid: schema => schema.min(1, "UUID is required"),
    key: schema => schema.min(1, "Key is required"),
    library: schema => schema.min(1, "Library uuid is required"),
  },
)
  .omit({
    createdAt: true,
...
export const insertAlbumSchema = createInsertSchema(
  albums,
  {
    ...
    key: schema => schema.min(1, "Key is required"),
    library: schema => schema.min(1, "Library uuid is required"),
    artist: schema => schema.min(1, "Artist uuid is required"),
  },
)
  .omit({
    createdAt: true,
...
export const insertTrackSchema = createInsertSchema(
  tracks,
  {
    ...
    library: schema => schema.min(1, "Library uuid is required"),
    artist: schema => schema.min(1, "Artist uuid is required"),
    album: schema => schema.min(1, "Album uuid is required"),
    trackNumber: schema => schema.min(1, "Track number is required"),
  },
)
  .omit({
    createdAt: true,
