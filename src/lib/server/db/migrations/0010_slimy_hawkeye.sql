...
--> statement-breakpoint
INSERT INTO `__new_settings`("id", "library", "plex_library_sync_interval", "created_at", "updated_at") SELECT "id", "library", "plex_library_sync_interval", "created_at", "updated_at" FROM `settings`;--> statement-breakpoint
