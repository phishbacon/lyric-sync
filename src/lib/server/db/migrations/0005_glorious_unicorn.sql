ALTER TABLE `libaries` RENAME TO `libraries`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tracks`("title", "uuid", "key", "path", "duration", "synced", "library", "artist", "album", "created_at", "updated_at") SELECT "title", "uuid", "key", "path", "duration", "synced", "library", "artist", "album", "created_at", "updated_at" FROM `tracks`;--> statement-breakpoint
